...
$config['menu_lists'] = array(	
					  'main_menu'=> array(
						  ...
						  'content'=> array(
									...
									2 => array (
										'program_type_list' => '节目类型',
										'program_type_add' => '类型添加',
										'program_type_edit' => '类型编辑',									
										'program_type_del' => '类型删除',
									),
								    3 => array (
										'programme' => '节目单',
                                        'programme_view' => '查看节目',
										'programme_add' => '节目单添加',
										'programme_edit' => '节目单编辑',									
										'programme_del' => '节目单删除',
									),
                                    4 => array(
                                        'tag' => '标签管理',
