...
class CI_Session
{
    ...
    var $flash_key = 'flash'; // prefix for "flash" variables (eg.
                              // flash:new:message)
    ...
    function _sess_run ()
    {
        ...
        if (is_numeric($session_id_ttl)) {
            if ($session_id_ttl > 0) {
                $this->session_id_ttl = $this->object->config->item(
                        'sess_expiration');
            } else {
     ...
     * You can use it to implement "Save succeeded" messages
     * after redirect.
     */
