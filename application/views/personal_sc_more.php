...
<div class="main">
    ...
    <div class="radio_right">
        <div class="radio_list">
            <div class="radio_title">我收藏的节目单<!--a href="index.php?c=personal&m=addprogramme"><img src="static/images/notification_add.png"></a--></div>
            <div class="find_pic">
        ...
        <div class="radio_title">我收藏的节目</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.ajax_mpage').live('click', function(eve){
            ...
            var offset=arr[1];
            $.ajax({
                url:"index.php?c=zhubo&m=sc_programme_page",
                type:"get",
                dataType:"text",
                data: {
                    //    offset:offset,
