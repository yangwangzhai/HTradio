	...
	<div id="usual1" class="usual">
		<form action="<?=$this->baseurl?>&m=save" method="post">
			...
			<div id="tab1" class="tabson">
					<ul class="forminfo">
					<li><label>语音<b>*</b></label><input name="value[audio]" value="<?=$value[audio]?>" type="text" class="dfinput" style="width:518px;"/></li>
					<li><label>内容<b>*</b></label>
						<textarea id="content7" name="value[content]" style="width:700px;height:250px;visibility:hidden;"><?=$value['content']?></textarea>
					</li>
