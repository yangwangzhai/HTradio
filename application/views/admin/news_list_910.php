...
$(document).ready(function(){ 
	...
	$(".choose").click(function(){
		...
		var dialog = mKindEditor.dialog({
						...
						height: 550,
						title : '选用新闻：',
						body : '<iframe	src="index.php?d=admin&c=news&m=add&radio=1" id="iframe1" width="100%" name="iframe1" height="100%" frameborder="0" scrolling="yes" style="overflow: auto;"></iframe>',
						closeBtn : {
							name : '关闭',
							click : function(e) {
								dialog.remove();
...
<div class="mainbox">
    ...
    <a href="<?=$this->baseurl?>&m=index" >返回<< </a> &nbsp;&nbsp;&nbsp;&nbsp;       
		<a href="<?=$this->baseurl?>&m=list_910&radio=910" <?php if($radio=='910'){echo "class='rss_title_on'";}?>>910新闻</a> &nbsp; |&nbsp;
		<a href="<?=$this->baseurl?>&m=list_970&radio=970" <?php if($radio=='970'){echo "class='rss_title_on'";}?>>970新闻</a> &nbsp;&nbsp;
    ...
    <tr class="sortTr">
				...
				<td><a href="javascript:;" class="choose" title="<?=htmlspecialchars($r['content'])?>">选用</a></td>
				<td><?=times($r['dateline'],1)?></td>
			</tr>
    <?php }?>
     <tr>
