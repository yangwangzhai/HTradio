...
class role_group extends Content
{
    function __construct ()
    {    
        parent::__construct();
            
        $this->control = 'role_group';
        $this->baseurl = 'index.php?d=admin&c=role_group';
        $this->table = 'fm_role_group';
        $this->list_view = 'role_group_list';
